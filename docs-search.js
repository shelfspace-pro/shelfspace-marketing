(function() {
  ...
  var DOCS = [
    ...
    { t: "How ShelfSpace Billing Works", n: "Billing & Fees", d: "Two tiers — Visibility is free forever; Automate is a monthly subscription (retailers from $749/location, vendors from $499/mo) with a 30-day free trial. ACH included, mailed checks $5.", s: "Billing", u: "/docs/billing/overview", k: "billing fees pricing cost subscription automate visibility tier fee statement charge what does it cost monthly how much do i pay collection trial" },
