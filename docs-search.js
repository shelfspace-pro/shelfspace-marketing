(function() {
  ...
  var DOCS = [
    ...
    { t: "Weekly Consignment Settlements", n: "Weekly Settlements", d: "How weekly payouts are calculated from POS data, category splits, returns, and credits. Penny-precise.", s: "Consignment", u: "/docs/consignment/settlements", k: "payout weekly settlement remittance vendor pay weekly check consignment payment accrual week sell-through" },
    ...
    { t: "Partnership Setup and Terms", n: "Partnership & Terms", d: "Every vendor is set up automatically as both a consignment and wholesale partner. You set the splits, caps, and payment terms — the platform applies them.", s: "Consignment", u: "/docs/consignment/contracts", k: "agreement terms consignment terms payment terms Net 30 Net 45 partnership splits caps setup vendor terms wholesale consignment" },
    { t: "Category Splits and Profit Sharing", n: "Profit Splits", d: "How category-level splits are set by the retailer, configured, and applied in settlements.", s: "Consignment", u: "/docs/consignment/profit-splits", k: "split percentage margin gross category split profit share revenue share keystone vendor share retailer share" },
    { t: "Aged Inventory on Consignment", n: "Aged Inventory on Consignment", d: "Consignment settlements carry no aging deduction — the split of the actual sale price already shares every markdown.", s: "Consignment", u: "/docs/consignment/aging-discounts", k: "aging consignment markdown stale dead stock shelf age no deduction pure split retired aging tiers margin deficit slow mover" },
    ...
    { t: "The Invoice Payoff Tab", n: "Invoice Payoff", d: "Reconcile every consignment invoice to the unit — received, sold, returned, destroyed, remaining — traced back to the original invoice. Audit-ready for retailers and vendors.", s: "Consignment", u: "/docs/consignment/invoice-payoff", k: "invoice payoff consignment reconciliation units received sold returned destroyed remaining reconcile invoice sell-through by invoice audit state audit examiner closed open partial status Metrc package tag reconciliation delta how much sold against invoice vendor visibility Data page consignment tab export PDF" },
    ...
    { t: "Generate Credit Memos Yourself (Self-Serve)", n: "Self-Serve Generation", d: "Pick a closed month, upload four Dutchie reports, clear pre-flight, and the platform drafts one credit memo per vendor to review and send.", s: "Credit Recovery", u: "/docs/credit-recovery/self-serve", k: "self serve self-serve generate credit memos wizard upload reports dutchie preflight pre-flight map vendors drafts build monthly credit memos yourself do it yourself run credit recovery on demand" },
    { t: "How to Configure Your Credit Recovery Settings", n: "Settings & Defaults", d: "Set your coverage rates, pick the report categories, decide what auto-approves on vendor silence, and route approved memos to your accounting team — once, before your first batch.", s: "Credit Recovery", u: "/docs/credit-recovery/settings", k: "credit recovery settings defaults coverage rates target retail margin returns waste coverage co-marketing coverage aging markdown coverage credit memo fee categories on the report auto-approve on silence book automatically default terms email approved credit memos to my team recipients when to send send to vendor configure setup" },
    { t: "Read Your Credit Recovery Scorecard", n: "Scorecard", d: "Credit identified, requested, approved, and your recovery rate by source — plus where to focus to recover more.", s: "Credit Recovery", u: "/docs/credit-recovery/scorecard", k: "scorecard credit recovery performance recovery rate identified requested approved decided pending where to focus co-marketing returns waste inventory aging analytics dashboard reporting month over month leaking" },
    ...
    { t: "Inventory Aging Credits", n: "Inventory Aging Credits", d: "Aged wholesale inventory sold below keystone earns a vendor credit; category-aware thresholds and coverage rate.", s: "Credit Recovery", u: "/docs/credit-recovery/aging", k: "aging aged inventory slow mover stale old stock shelf age threshold below keystone markdown price drop coverage rate wholesale 60 120 days flower pre-roll concentrate vape edible" },
    { t: "Price Drops", n: "Price Drops", d: "Ask a vendor to cover part of a markdown on aged wholesale product before you drop the price; approval lands on the monthly credit memo.", s: "Credit Recovery", u: "/docs/credit-recovery/price-drops", k: "price drop price drops aged inventory slow mover stale markdown opportunities tab vendor approval approve decline aging thresholds coverage rate wholesale mark down clear shelf" },
    { t: "Credit Memo Approval Process", n: "Approval Workflow", d: "The three ways a vendor responds — approve, approve a specific amount, or decline — all handled by ShelfiQ, plus what happens on silence.", s: "Credit Recovery", u: "/docs/credit-recovery/approval-workflow", k: "approval workflow status Draft Pending Vendor Approved Applied Declined automatic approval 10 calendar day review window vendor response approve specific amount decline silence" },
    { t: "Does ShelfiQ Answer Vendor Questions on My Credit Memos?", n: "ShelfiQ Credit Memo Replies", d: "Yes — automatically, for every memo you send. ShelfiQ reads each vendor reply against your real data and closes the memo to approved, partial, or declined. No AP inbox needed.", s: "Credit Recovery", u: "/docs/credit-recovery/shelfiq-credit-memo-replies", k: "shelfiq answer vendor questions credit memo replies vendor reply automatic no setup AP inbox auto-responder separate reply-to routing recognize vendor approve partial decline conversation portal notification unsubscribed new email address" },
    { t: "Send Credit Memos to Your Accounting Team", n: "Accounting Export", d: "Auto-email approved credit memos to your bookkeeper as a CSV plus PDFs, export on demand, and mark credits applied outside ShelfSpace.", s: "Credit Recovery", u: "/docs/credit-recovery/accounting-export", k: "accounting export credit memo bookkeeper quickbooks xero csv summary pdf zip download email approved credit memos to accounting mark applied outside shelfspace weekly monthly digest reconcile record credit externally send to accountant records" },
    ...
    { t: "Cannabis Vendor W-9 & Resale Certificate Collection", n: "Tax Forms", d: "Collect vendor W-9s in the onboarding invite, e-sign your own W-9 and state resale certificate, and share every tax document with an encrypted, logged trail.", s: "Accounts Payable", u: "/docs/accounts-payable/tax-forms", k: "W9 W-9 EIN tax form tax document resale certificate exemption certificate ST-4 ST4 sales tax 1099 federal tax classification e-sign vendor tax onboarding paperwork" },
    ...
    { t: "Partial Invoice Payments", n: "Partial Payments", d: "Pay part of a wholesale or non-cannabis vendor invoice. The invoice stays open with a remaining balance, keeps showing as due, and the vendor is notified automatically.", s: "Accounts Payable", u: "/docs/accounts-payable/partial-payments", k: "partial payment partial invoice payment pay part of invoice remaining balance installment pay half short pay pay down invoice open balance amount due partially paid split payment pay in parts" },
    ...
    { t: "Voiding and Reissuing Checks", n: "Void & Reissue", d: "Re-issue a stale-dated, bounced, or lost vendor check. Void the original, then re-pay the order for a replacement with a fresh date and new check number.", s: "Checks", u: "/docs/checks/void-reissue", k: "void reissue cancel stop payment lost check replacement check reissue void check cancel check check problems stale dated bounced lost in mail re-pay" },
    ...
    { t: "How ShelfSpace Billing Works", n: "Billing", d: "The first step is free — see exactly what you're owed. Pricing is scoped to your operation in a consult; you approve anything that moves money.", s: "Billing", u: "/docs/billing/overview", k: "billing pricing cost fee statement charge what does it cost how much do i pay consult scoped" },
    { t: "Cannabis Vendor Portal", n: "Overview", d: "Where every vendor checks downloads, payment history, and credit memos across all retailer partners; the retailer is the paying party, not the vendor.", s: "Vendor Portal", u: "/docs/vendor-portal/overview", k: "vendor portal vendor login supplier portal vendor sign in partner portal ourshelf.space vendor access supplier login" },
    { t: "ShelfCollect — Vendor AR Collections", n: "ShelfCollect", d: "Collect on overdue dispensary invoices — send a branded Pay Now email, reminders go out on a schedule, and the buyer pays from their own bank. You get a check.", s: "Vendor Portal", u: "/docs/vendor-portal/get-paid", k: "get paid collect overdue invoice past due dunning reminders pay now vendor collections accounts receivable AR collect payment plan installment chase dispensary who owes me buyer pays own bank check drawn on bank never touches money" },
    { t: "Sales Rep Assignments", n: "Sales Rep Assignments", d: "Put the right sales rep on every account — assign by account, by rep, in bulk, or from a spreadsheet, and filter AR Aging by rep. The primary rep is auto-CC'd on settlement and payment emails.", s: "Vendor Portal", u: "/docs/vendor-portal/sales-rep-assignments", k: "sales rep account rep territory manager covered states assign rep assign accounts bulk assign import spreadsheet excel csv primary rep who owns the account rep roster vendor rep cc email loop in sales representative ar aging filter by rep unassigned accounts" },
    { t: "Weekly Sales Rep Collections Email", n: "Weekly Rep Collections Email", d: "Every Monday, each sales rep gets every open invoice on their accounts, oldest first, with one-tap Text and Email buttons that send the buyer a pay link. No logins.", s: "Vendor Portal", u: "/docs/vendor-portal/weekly-sales-rep-digest", k: "weekly digest sales rep collections email monday ar report rep ar digest open invoices text buyer pay link email buyer collections list rep book unassigned accounts ar contact preview send test shelfcollect get paid" },
    ...
    { t: "Vendor Dispute Credit Memo", n: "Disputes", d: "How vendors review credit memos — approve, approve a specific amount, or decline — and upload documentation through the portal.", s: "Vendor Portal", u: "/docs/vendor-portal/disputes", k: "dispute reject decline disagree push back contest approve specific amount challenge credit memo dispute vendor disagree dispute charges" },
    { t: "Get a Retailer's W-9 & Resale Certificate", n: "Retailer Tax Documents", d: "Pull a partner retailer's W-9 and resale/exemption certificate (ST-4) straight from the portal — self-serve for vendor admins on an active partnership, every view logged.", s: "Vendor Portal", u: "/docs/vendor-portal/retailer-tax-documents", k: "retailer W-9 W9 resale certificate exemption certificate ST-4 ST4 tax form tax document get retailer tax docs dispensary W9 buyer resale cert download retailer tax onboarding docs bookkeeper tax exempt sell for resale" },
    ...
    { t: "POS Integration", n: "POS Integration", d: "Works with any system. Export a CSV from Dutchie, Flowhub, BLAZE, or any POS and upload it — smart header mapping, no IT team required.", s: "Integrations", u: "/docs/integrations/pos", k: "Dutchie Flowhub BLAZE point of sale POS Treez Cova Meadow IndicaOnline MJ Freeway Greenbits CSV upload sales export" },
    ...
    { t: "Manifest-First Receiving for Cannabis", n: "Manifest-First", d: "Match every Metrc manifest to your delivery before you receive it — catch stale product, quantity gaps, and mismatches so you never overpay.", s: "Deliveries", u: "/docs/deliveries/manifest-first-receiving", k: "freshness stale old product packaged date perishable metrc manifest match receive gate reject expired quantity mismatch overpay aging flower shelf life" },
