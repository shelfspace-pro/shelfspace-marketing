(function() {
  ...
  var DOCS = [
    ...
    { t: "Sales Rep Assignments", n: "Sales Rep Assignments", d: "Put the right vendor sales rep on every account — automatically by state coverage, with per-account overrides. The primary rep is auto-CC'd on settlement and payment emails.", s: "Vendor Portal", u: "/docs/vendor-portal/sales-rep-assignments", k: "sales rep account rep territory manager covered states assign rep primary rep who owns the account rep roster vendor rep cc email loop in sales representative" },
