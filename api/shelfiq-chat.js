...
- Honest status labels — Sent, Viewed, Check Received, Deposited (the vendor marks it deposited themselves), Bounced/Reopened, Pending Review (held). There is no bank feed on a Get Paid check, so a status advances only as far as "Deposited" and NEVER to "Cleared".
