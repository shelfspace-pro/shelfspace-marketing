...
- **Same vendor, two modes:** one vendor record holds both Wholesale Settings (AP terms) and Consignment Settings (Master Vendor Split + Operational Discount Cap + per-category splits). The same brand can ship you a wholesale order and a consignment order on the same day — different invoices, different Metrc manifests.
